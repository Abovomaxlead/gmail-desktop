...
// detection should stop. An empty identity or an already-seen address ends the run:
 ...
 * @param identity what the probed view reported
...
export function planNext(
  ...
  if (!identity.email) return { register: false, stop: true };
